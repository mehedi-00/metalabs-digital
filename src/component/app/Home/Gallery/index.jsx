          ...
          gallery.map((data, index) => <div className="relative" key={index}>
            ...
            <div className="absolute bg-black opacity-0 hover:opacity-50 top-0 bottom-0 left-0 right-0 duration-300">
              <div className="relative h-full">
                <div className="absolute transform translate-x-44 translate-y-28 sm:translate-x-40 sm:translate-y-28 md:translate-x-48 md:translate-y-36">
                  <p className="text-white md:text-lg">{data.icon}</p>
                </div>
